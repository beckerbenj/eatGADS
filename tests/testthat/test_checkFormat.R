...
g <- import_raw(df = data.frame(var1 = c("ab c","bb"), var2 = c(1,NaN), var3 = c(1.01, 2.00), var4 = c(1.0001, 4.00187243564195786431587643596), var5=c("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore","aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata ähh öh üh"),stringsAsFactors = FALSE),
                                varLabels = data.frame(varName = c("var1", "var2", "var3", "var4", "var5"), varLabel = c("a label", NA, "another label", NA, "lorem ipsum"), stringsAsFactors = FALSE),
                                valLabels = data.frame(varName = c("var1", "var1", "var2", "var2", "var2","var3", "var3","var5"), value = c(-96, -99, -99, 0, 1,-96, -99,-99),
                                                       valLabel = c("miss1", "miss2", "miss2","right","wrong","miss1", "miss2", "missing"),
                                                       missings = c("miss", "miss", "miss","valid","valid","miss", "miss", "miss"), stringsAsFactors = FALSE))
