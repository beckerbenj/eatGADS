...
author: "Marlen Holtman, Johanna Busse, Benjamin Becker"
date: "`r Sys.Date()`"
...
# write to excel
meta_var_changed <- readxl::read_excel("variable_changes.xlsx")
```
