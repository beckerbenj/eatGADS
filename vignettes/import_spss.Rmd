...
As `haven` currently does not always import value labels and missing codes for long string variables correctly, specific warnings for these variables are issued. I recommend checking the correct import of these variables.
