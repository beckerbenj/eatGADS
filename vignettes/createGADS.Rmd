...
After reshaping we adapt the meta data in our initial `GADSdat` object via `updateMeta()`. Now we have to add some variable labels, as most of the old variable labels got lost due to the reshaping. For an extensive tutorial see the vignette handling meta data.
...
For a detailed tutorial on how to use a relational `eatGADS` data base see the vignette ...
