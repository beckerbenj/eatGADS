...
# fill in strings
gads$dat$stringvar <- c("German", "Ger", "Ger", "", "Eng, Pol, Ita", "Pol, Ita, Germ", "eng, ita", "germ, pol", "polish", "eng, ita", -99)
...
gads_string3 <- remove2NAchar(GADSdat = gads_string2, 
                              ...
                              max_num = 2, na_value = -97, na_label = "missing: excessive answers")
