...
Returns either `TRUE` if the variable is unique within each value for
`idVar` or a `GADSdat` object including the not unique cases.
...
identifier can be tricky. This function automates this task.
