...
- [`applyNumCheck()`](https://beckerbenj.github.io/eatGADS/reference/applyNumCheck.md)
...
- [`checkTrendStructure()`](https://beckerbenj.github.io/eatGADS/reference/checkTrendStructure.md)
  :
...
- [`clean_cache()`](https://beckerbenj.github.io/eatGADS/reference/clean_cache.md)
...
- [`createNumCheck()`](https://beckerbenj.github.io/eatGADS/reference/createNumCheck.md)
  : Create data.frame for specification of numerical plausibility
  checks.
...
- [`extractGADSdat()`](https://beckerbenj.github.io/eatGADS/reference/extractGADSdat.md)
  :
...
- [`import_convertLabel()`](https://beckerbenj.github.io/eatGADS/reference/import_convertLabel.md)
  :
...
- [`labelsGADS()`](https://beckerbenj.github.io/eatGADS/reference/labelsGADS.md)
  :
...
- [`miss2NA()`](https://beckerbenj.github.io/eatGADS/reference/miss2NA.md)
  :
...
- [`pisa`](https://beckerbenj.github.io/eatGADS/reference/pisa.md) :
...
- [`stringAsNumeric()`](https://beckerbenj.github.io/eatGADS/reference/stringAsNumeric.md)
