...
#' Hierarcical data sets are combined via \code{\link{mergeLabel}} and the data base is created via \code{\link{createGADS}}. For this, the package \code{eatDB} is utilized. See also \code{\link[eatDB]{createDB}}.
#'
